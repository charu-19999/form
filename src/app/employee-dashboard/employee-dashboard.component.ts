...
export class EmployeeDashboardComponent implements OnInit {
  ...
  postEmployeeDetails() {
    ...
    this.employeeModelObj.Temporary = this.formValue.value.Temporary;
    this.employeeModelObj.Permanent = this.formValue.value.Permanent;
  ...
  updateEmployee(row: any) {
    ...
    this.formValue.controls['Temporary'].setValue(row.Temporary);
    this.formValue.controls['Permanent'].setValue(row.Permanent);
